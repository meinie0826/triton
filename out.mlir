...
#loc = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0)
module {
  tt.func public @add_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0)) attributes {noinline = false} {
...
#loc1 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":39:24)
#loc2 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":44:24)
#loc3 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":45:41)
#loc4 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":45:28)
#loc5 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":47:21)
#loc6 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":50:24)
#loc7 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":50:16)
#loc8 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":51:24)
#loc9 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":51:16)
#loc10 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":52:17)
#loc11 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:26)
#loc12 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:35)
#loc13 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:4)
...
#loc1 = loc(unknown)
#loc2 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":39:24)
#loc3 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":44:24)
#loc4 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":45:41)
#loc5 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":45:28)
#loc6 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":47:21)
#loc7 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":50:24)
#loc8 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":50:16)
#loc9 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":51:24)
#loc10 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":51:16)
#loc11 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":52:17)
#loc12 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:26)
#loc13 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:35)
#loc14 = loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":54:4)
...
module attributes {ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 0 : i32, ttg.target = "cuda:90", ttg.tensor_memory_size = 0 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  tt.func public @add_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0)) attributes {noinline = false, ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32} {
    %c1024_i32 = arith.constant 1024 : i32 loc(#loc1)
    %0 = tt.get_program_id x : i32 loc(#loc2)
    %1 = arith.muli %0, %c1024_i32 : i32 loc(#loc3)
    %2 = tt.make_range {end = 1024 : i32, start = 0 : i32} : tensor<1024xi32, #blocked> loc(#loc4)
...
module attributes {ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 0 : i32, ttg.target = "cuda:90", ttg.tensor_memory_size = 0 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  ...
  llvm.func @add_kernel(%arg0: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg1: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg2: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0), %arg4: !llvm.ptr<1> loc("/home/meiziyuan/triton/python/tutorials/01-vector-add.py":30:0)) attributes {noinline = false, nvvm.kernel = 1 : ui1, nvvm.reqntid = array<i32: 128>, ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32} {
