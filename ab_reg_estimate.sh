...
print(f'{\"Shape\":<15} {\"WS_nop TF\":>10} {\"WS_nop TF\":>10} {\"WS_per TF\":>10} {\"WS_per TF\":>10} {\"WS_sub TF\":>10} {\"WS_sub TF\":>10} {\"nop_Delta%\":>9} {\"per_Delta%\":>9} {\"nop_B/cu%\":>8} {\"nop_A/cu%\":>8} {\"per_B/cu%\":>8} {\"per_A/cu%\":>8} {\"sub_B/cu%\":>8} {\"sub_A/cu%\":>8} {\"reqRegs_B\":>16} {\"reqRegs_A\":>16}')
print('-'*170)
nop_deltas = []
per_deltas = []
for bi, ai in zip(b, a):
    ...
    sbt, sat = bi.get('subtile_tflops', 0), ai.get('subtile_tflops', 0)
    ...
    sbc = bi.get('subtile_ratio_pct', 0)
    sac = ai.get('subtile_ratio_pct', 0)
    ...
    sbt_str = f'{sbt:.2f}' if sbt else 'ERR'
    sat_str = f'{sat:.2f}' if sat else 'ERR'
    sbc_str = f'{sbc:.1f}%' if sbc else 'N/A'
    sac_str = f'{sac:.1f}%' if sat else 'N/A'
    print(f'{n:<15} {bt:>10.2f} {at:>10.2f} {pbt_str:>10} {pat_str:>10} {sbt_str:>10} {sat_str:>10} {nop_d:>8.1f}% {per_d_str:>9} {bc:>7.1f}% {ac:>7.1f}% {pbc:>7.1f}% {pac:>7.1f}% {sbc_str:>8} {sac_str:>8} {str(br):>16} {str(ar):>16}')
